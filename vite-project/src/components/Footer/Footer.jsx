...
import InstagramLogo from '../../assets/instagran.svg'
import LinkedinLogo from '../../assets/linkedin.svg'
import Logo from '../../assets/DNC-logo.svg'
import TwitterLogo from '../../assets/x.svg'
import UsaLogo from '../../assets/EUA.svg'
...
function Footer() {
    ...
    const changeLanguage = (country) => {
        ...
        console.log("Idioma atual:", appContext.language)
        console.log("languages:", appContext.languages)
